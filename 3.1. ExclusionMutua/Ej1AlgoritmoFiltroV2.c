 ...
 *
 * La diferencia con respecto a la version anterior es que el algoritmo de filtro
 * se divide en dos funciones, para que se pueda usar en donde se necesite solamente
 * llamando a las funciones entrar_region_critica y salir_region_critica
 * 
...
void *incrementar(void *arg) {
    ...
    for (int j = 0; j < 100000; j++) {
        entrar_region_critica(i);
        // Region critica
        contador++;
        salir_region_critica(i);
        // Region no critica
    }
